...
<html>
  ...
  <body class="sidebar-mini fixed">
	...
	<div class="row text-center">
        ...
        <p style="font-size:20px;color:#5C5C5C;">Thank you for Booking the music fusion studio, please wait a little more for your order data to be verified by admin.</p>
