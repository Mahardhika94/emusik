    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-map-marker"></i> Lokasi E-Musik Studio</h1>
            <p>find me in Google
        ...
        <div class="row">
          <div class="col-md-12">
			...
			<div class="row-fluid">
        <div class="span8">
        	<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo $url; ?>"></iframe>
    	</div>
