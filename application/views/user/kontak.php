    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa  fa-phone-square"></i> Kontak E-Musik Studio</h1>
            <p>Contac Us
        ...
        <div class="span8">
        	<div class="well">
                ...
                <p style="margin-top:6%;line-height:35%"><?php echo $email; ?></p>
               </br>
                <h3 style="line-height:20%;"><i class="fa fa-phone fa-1x" style="line-height:6%;color:#339966"></i> Telphone / HP:</h3>
                <p style="margin-top:6%;line-height:35%"><?php echo $nope; ?></p>
