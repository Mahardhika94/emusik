...
<html>
  ...
  border: none;
  font: normal 36px/1 "Aclonica", Helvetica, sans-serif;
  color: rgba(40,72,94,0.92);
  text-align: center;
  ...
  <body class="sidebar-mini fixed">
    <div class="wrapper">
      <!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href="index.html">E-Music Studio</a>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<div>
		<form action="<?php echo site_url('User/jadwal2/1'); ?>" method="post" id="upware" name="upware">
              <div class="form-group">
                <div class="input-group">
...
endDate:'+13d',
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small>08.00-10.00 WIB (<?php echo $skr; ?>)</small>
    </div>
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small class="text-muted">10.00-12.00 WIB (<?php echo $skr; ?>)</small>
    </div>
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small class="text-muted">12.00-14.00 WIB (<?php echo $skr; ?>)</small>
    </div>
 <p class="mb-1"><a class="btn btn-info btn-block"><i class="fa fa-sticky-note-o fa-lg"> <?php if($s3==1){ echo "Terisi"; }else { echo "Kosong";} ?></i></a></p>
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small class="text-muted">14.00-16.00 WIB (<?php echo $skr; ?>)</small>
    </div>
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small class="text-muted"><i class="fa fa-clock-o fa-lg"></i> 17.00-18.00 WIB (<?php echo $skr; ?>)</small>
    </div>
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small class="text-muted">20.00-22.00 WIB (<?php echo $skr; ?>)</small>
    </div>
  ...
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      ...
      <small class="text-muted">22.00-24.00 WIB (<?php echo $skr; ?>)</small>
    </div>
