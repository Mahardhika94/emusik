...
endDate:'+13d',
   ...
   <center><h4 class="active">
    <div class="enjoy-css">  Tampilan Jadwal & Reservasi Fusion Studio</p>
	  Studio 1
      </div>
   </h4></center>
	...
	<a href="<?php echo site_url('User/jadwal2'); ?>" class="btn btn-warning btn-block"><i class="fa fa-check fa-lg"> Cek Studio 2 </i></a>
  <p>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1 active">Sift 1</h3>
      <small>09.00-11.00 WIB</small>
    </div>
    ...
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s1/1/'. $skr.''); ?>" class="btn <?php if($s1==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s1==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1">Sift 2</h3>
      <small class="text-muted">011.00-13.00 WIB</small>
    </div>
    ...
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s2/1/'. $skr.''); ?>" class="btn <?php if($s2==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s2==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1">Sift 3</h3>
 ...
 <p class="mb-1"><a class="btn btn-info btn-block"><i class="fa fa-sticky-note-o fa-lg"> <?php if($s3==1){ echo "Terisi"; }else { echo "Kosong";} ?></i></a></p>
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s3/1/'. $skr.''); ?>" class="btn <?php if($s3==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s3==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1">Sift 4</h3>
      <small class="text-muted">15.00-17.00 WIB</small>
    </div>
    ...
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s4/1/'. $skr.''); ?>" class="btn <?php if($s4==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s4==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1">Sift 5</h3>
      <small class="text-muted"><i class="fa fa-clock-o fa-lg"></i> 17.00-19.00 WIB</small>
    </div>
    ...
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s5/1/'. $skr.''); ?>" class="btn <?php if($s5==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s5==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1">Sift 6</h3>
      <small class="text-muted">19.00-21.00 WIB</small>
    </div>
    ...
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s6/1/'. $skr.''); ?>" class="btn <?php if($s6==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s6==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
  <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
    <div class="d-flex w-100 justify-content-between">
      <h3 class="mb-1">Sift 7</h3>
      <small class="text-muted">21.00-23.00 WIB</small>
    </div>
    ...
    <small class="text-muted"><a href="<?php echo site_url('Insert/boking/s7/1/'. $skr.'' ); ?>" class="btn <?php if($s7==1){ echo "btn-danger"; }else { echo "btn-success";} ?> btn-block" <?php if($s7==1){ echo 'disabled = "disabled"'; } ?> ><i class="fa fa-check fa-lg"> Boking</i></a></small>
  </a>
</div>
            </div>
          </div>
