    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <h3 class="card-title">Perbarui Agenda</h3>
              <div class="card-body">
                <form rule="form" action="<?php echo site_url('Update/up_agenda').'/'. $id_agenda .''; ?>" method="post">
                  <div class="form-group">
                    <label class="control-label">Judul Agenda</label>
                    <input class="form-control" type="text" placeholder="Judul Agenda" name="judul" value="<?php echo $judul_agenda; ?>">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Agenda</label>
                    <textarea class="form-control" rows="4" name="agenda"><?php echo $isi_agenda; ?></textarea>
                  </div>
