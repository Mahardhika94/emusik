...
<div>
<a href="<?php echo site_url('Index/reservasi'); ?>" target="_blank" class="btn btn-warning btn-flat"  ><i class="fa fa-home fa-home"></i> Studio 1</a>
...
<div class="modal fade" id="myModal" role="dialog">
      <div class="modal-dialog">
		...
		<div>
<form role="form" action="<?php echo site_url('Index/reservasi2/1'); ?>" method="post">
              <div class="form-group">
                <div class="input-group">
