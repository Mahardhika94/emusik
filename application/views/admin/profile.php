	...
	<a class="sidebar-toggle" href="#" data-toggle="offcanvas"></a>
          ...
          <div class="navbar-custom-menu">
            <ul class="top-nav">
              ...
              <!-- User Menu-->
              <li class="dropdown active"><a class="dropdown-toggle" href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user fa-lg"></i></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo site_url('Update/up_profile/'. $username.''); ?>" method="post">
