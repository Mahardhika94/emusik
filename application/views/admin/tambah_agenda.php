    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit"></i> Agenda</h1>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo site_url('Insert/input_agenda'); ?>" method="post" >
                  <div class="form-group">
                    <label class="control-label">Judul Agenda</label>
                    <input class="form-control" type="text" placeholder="Judul Agenda" name="judul">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Agenda</label>
                    <textarea class="form-control" rows="4" name="agenda"></textarea>
                  </div>
              ...
              <div class="card-footer">
                <button class="btn btn-primary icon-btn" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Tambahkan Agenda</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-default icon-btn" href="#"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
              </div>
			  </form>
            </div>
          </div>
