        ...
        <div class="page-title">
          <div>
            ...
            <ul class="breadcrumb side">
              ...
              <li>Agenda</li>
              <li class="active"><a href="#">List Agenda</a></li>
            </ul>
          </div>
        </div>
        <div class="row">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
				  ...
				  ?>
                    <tr>
                      ...
                      <td><a href="<?php echo site_url('Insert/del_agenda/'. $row->id_agenda .''); ?>" class="btn btn-danger"><i class="fa fa-times-circle"></i> Hapus Agenda </a></td>
                      <td><a href="<?php echo site_url('Index/up_agenda/'. $row->id_agenda .''); ?>" class="btn btn-info" ><i class="fa fa-edit"></i><span>Update</span></a></td>
                    </tr>
                   <?php } ?>
                  </tbody>
                </table>
